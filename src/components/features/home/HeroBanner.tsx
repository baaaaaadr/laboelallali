      ...
      <div className="container mx-auto px-2 py-16 sm:px-4 sm:py-20 md:py-32 relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 w-full">
            <a
              href="tel:0528843384"
              className="flex items-center justify-center min-w-[170px] h-12 px-6 bg-[var(--accent-fuchsia)] text-white font-semibold rounded-lg shadow transition-colors text-center text-lg hover:bg-[#F50057] focus:bg-[#F50057] gap-2 w-full sm:w-auto"
            >
            ...
            <a
              ...
              className="flex items-center justify-center min-w-[220px] h-12 px-6 bg-[var(--accent-fuchsia)] text-white font-semibold rounded-lg shadow transition-colors text-center text-lg hover:bg-[#F50057] focus:bg-[#F50057] gap-2 w-full sm:w-auto"
            >
